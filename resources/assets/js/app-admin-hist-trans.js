...
$(function () {
  ...
  var dt_user_table = $('.datatables-users'),
    select2 = $('.select2'),
    userView = baseUrl + 'admin/histloginview',
    statusObj = {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
	  ...
	  ajax: {
        url: baseUrl + 'admin/histlogindata'
      },
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $event_name = full['event_name'];

            return '<span class="text-heading">' + $event_name + '</span>';
          }
        },
        {
          targets: 3,
        ...
        },
        {
          targets: 5,
          render: function (data, type, full, meta) {
            var $ip_address = full['ip_address'];

            return '<span class="text-heading">' + $ip_address + '</span>';
          }
        },
		{
          targets: 6,
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-heading">' + formattedLocalDate + '</span>';
          }
        },
        {
          // Actions
