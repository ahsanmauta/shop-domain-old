    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('')}}#Features">Features</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('')}}#FAQ">FAQ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('')}}#Contact">Contact us</a>
          </li>
        </ul>
      </div>
