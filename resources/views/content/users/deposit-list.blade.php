	  ...
	  <div class="col-lg-8 mb-8">
		<div class="card h-100">
		  <div class="card-header d-flex justify-content-between align-items-center">
			<h5 class="card-title m-0 me-2">My Deposits</h5>
			<div class="dropdown">
			...
			<table class="table table-borderless border-top datatables-projects"  >
			  ...
			  <tbody>
				...
				<tr>
				  ...
				  <td class="pt-5">
					<p class="mb-0 text-heading">{{ $deposit->tanggal }}</p>		
				  </td>
				  <td class="pt-5">
					<p class="mb-0 text-heading">{{ $deposit->tipebayar }}</p>
				  </td>
				  <td class="pt-5">
					<p class="mb-0 text-heading">{{ $deposit->note }}</p>
				  </td>
				  <td class="pt-5">
					<p class="mb-0 text-heading">${{ $deposit->amount }}</p>
				  </td>
				</tr>
				@endforeach
			  </tbody>
